<!DOCTYPE html><html lang="en"><head>
  ...
  <style>
    body {
      ...
      height: 100vh;
      margin: 0;
      background-image: url("https://i.postimg.cc/029xmZVt/IMG-20250801-003906-211.jpg"); /* Set the background image */
...
<body>
  <div class="container">
    <div class="main">
      <div class="box" id="box">
        <div id="text">
          ...
          <p>
            <h2 class="centered-text">NIMA PAIR</h2>           
            <h6>⚙Enter your number with country code.⚙</h6>
            <div class="input-container">
              <input placeholder="94726800969" type="number" id="number" placeholder="⚙enter your phone number with country code⚙" name="">
    ...
    <div class="glowing-text">CREATED BY NIMA CODER</div>
  </div>
